...
public class AreaCalculator {
     ...
     *  2. Calculates the area of the square. A = sideÂ²
     */
    ...
    /**
     * Function name: areaRectangle â€“ returns the area of a rectangle.
     * @param length (double).
     * @param width  (double).
     * @return the area (double)
     *
    ...
    /**
     * Function name: areaTriangle â€“ it returns the area of a triangle.
     * @param base: (double).
     * @param height: (double).
     * @return the area (double)
     *
    ...
    /**
     * Function name: areaCircle â€“ it returns the area of a circle.
     * @param radius (double).
     * @return area (double)
     *
     * Inside the function:
    ...
    /**
     * Function name: printAreas â€“ it prints four areas
     * @param square â€“ square area (double)
     * @param rectangle â€“ rectangle area (double)
     * @param triangle â€“ triangle area (double)
     * @param circle â€“ circle area (double)
     *
     * Inside the function:
